...
export default function Homepage() {
  ...
  useEffect(() => {
    ...
    const paginatedData = data.slice(startIndex, startIndex + PAGE_LIMIT);

    setFilteredProducts(paginatedData);
  }, [products, searchTerm, filter, sort, currentPage]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Discover the latest Samsung technology. From smartphones to smart
              TVs, experience innovation at its finest.
            </p>
                ...
                <div className={viewMode === "list" ? "flex-1" : ""}>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="flex items-center space-x-2 px-4 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white"
                    >
        ...
        <div className="mt-16 bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              Your trusted Samsung partner for the latest technology and
              innovation
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Free shipping on orders over $500 with same-day delivery
                available
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                24/7 customer service with Samsung certified technicians
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibant text-white mb-2">
                Quality Guarantee
              </h4>
              <p className="text-gray-400">
